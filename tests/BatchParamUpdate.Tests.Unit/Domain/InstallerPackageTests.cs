...
{
    [Fact]
    public void SupportedRevitYears_IsClosedList_2025_2026_2027()
    {
        Assert.Equal([2025, 2026, 2027], InstallerPackage.SupportedRevitYears);
    }

    [Fact]
    public void OffersInstallFor_NeverIncludesYearsOutsideSupportedList()
    {
        var package = new InstallerPackage([2024, 2025, 2028]);
